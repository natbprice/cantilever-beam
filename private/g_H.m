function [g]=g_H(x_norm,u_norm,E,opts)
% Prediction of the limit-state function including Kriging model error
% (Euler-Bernoulli model + Kriging)
%
% Inputs:
...
%
% Outputs:
% g = prediction of limit-state function evaluated at inputs
%==========================================================================
...
g=dtip-d+e_H(x_norm,u_norm,E,opts);
